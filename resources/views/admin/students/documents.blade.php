...
<div class="min-h-screen bg-gradient-to-br from-gray-950 via-blue-950 to-gray-900 relative overflow-hidden p-8">
    ...
    <div class="relative z-10 flex items-center justify-between mb-8">
        ...
        <a href="{{ route('admin.students.index') }}" class="px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-500 text-white">Back to list</a>
    </div>
    ...
    <div class="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        {{-- Submitted Documents with Verification --}}
        <div class="bg-blue-900/40 border border-blue-800/50 rounded-2xl p-6 backdrop-blur-xl">
                        ...
                        <tbody>
                            @foreach($student->documents as $doc)
                                <tr>
                                    ...
                                    <td class="px-4 py-2">
                                        <form method="POST" action="{{ route('admin.documents.verify', $doc) }}" class="inline-flex items-center gap-2">
                                            @csrf
                                            @method('PATCH')
