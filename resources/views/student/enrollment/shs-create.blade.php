...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-8 px-4">
    <div class="max-w-5xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-2xl border border-gray-100 mb-8 overflow-hidden">
            <div class="px-8 py-10 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 relative">
                ...
                <div class="flex items-center space-x-6 relative z-10">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold text-white mb-2">Senior High School Enrollment</h1>
                        <p class="text-blue-100 text-lg font-medium">Complete your SHS registration for Grade 11 & 12</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        {{-- Form --}}
        <form action="{{ route('student.enrollment.shs.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:scale-[1.01]">
                ...
                <div class="p-8 space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div>
                            <label for="strand" class="block text-base font-semibold text-gray-800 mb-3">Strand *</label>
                            <select name="strand" id="strand" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-800 font-medium transition-all duration-200">
                                ...
                                <option value="STEM" {{ old('strand') == 'STEM' ? 'selected' : '' }}>STEM (Science, Technology, Engineering, Mathematics)</option>
                                <option value="ABM" {{ old('strand') == 'ABM' ? 'selected' : '' }}>ABM (Accountancy, Business, Management)</option>
                                ...
                                <option value="TVL-IA" {{ old('strand') == 'TVL-IA' ? 'selected' : '' }}>TVL - IA (Industrial Arts)</option>
                                <option value="ARTS" {{ old('strand') == 'ARTS' ? 'selected' : '' }}>ARTS and Design</option>
